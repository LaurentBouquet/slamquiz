 ...
 */
final class Version20200227175338 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tbl_quiz ALTER summary DROP NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tbl_quiz ALTER summary SET NOT NULL');
    }
}
